 ...
 * @author John Jenkins
 */
public class EventReadChunkedRequest extends UserRequest {
	private static final Logger LOGGER = Logger.getLogger(EventReadChunkedRequest.class);
	 ...
	 */
	public EventReadChunkedRequest(HttpServletRequest httpRequest) throws IOException, InvalidRequestException {
