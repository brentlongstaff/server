 ...
 * @author John Jenkins
 */
public class EventUploadRequest extends Request {
	private static final Logger LOGGER = Logger.getLogger(EventUploadRequest.class);
	 ...
	 */
	public EventUploadRequest(HttpServletRequest httpRequest) throws IOException, InvalidRequestException {
